...
export const sendForgotPasswordOTPEmail = async (toEmail, otp, name) => {
  ...
  console.log(`[EMAIL SEND] Reset OTP Code: ${otp}`);
  console.log('==================================================\n');
...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Reset your CodeArena Password</title>
  <style type="text/css">
    body {
      margin: 0 !important;
      padding: 0 !important;
...
<body style="margin: 0; padding: 0; background-color: #f8fafc; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
    ...
    <tr>
      <td align="center" valign="top">
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; text-align: left;">
          ...
          <tr>
            <td style="padding: 32px 32px 20px 32px;">
              <h2 style="color: #1e293b; font-size: 20px; font-weight: 700; margin-top: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Reset Your Password</h2>
              <p style="color: #475569; font-size: 16px; line-height: 1.6; margin: 16px 0 0 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Hello ${name},</p>
              <p style="color: #475569; font-size: 16px; line-height: 1.6; margin: 12px 0 0 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">We received a request to reset your password. Please use the following One-Time Password (OTP) to reset your password and secure your account:</p>
            </td>
          </tr>
          <tr>
            <td style="padding: 0 32px;">
          ...
          <tr>
            <td style="padding: 24px 32px 32px 32px;">
              <p style="color: #475569; font-size: 14px; line-height: 1.6; margin: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">If you did not request a password reset, you can safely ignore this email and your password will remain unchanged.</p>
            </td>
          </tr>
          <tr>
            <td style="padding: 24px 32px; background-color: #f8fafc; border-top: 1px solid #f1f5f9; text-align: center; color: #94a3b8; font-size: 12px; border-bottom-left-radius: 12px; border-bottom-right-radius: 12px;">
  ...
  const textContent = `Hello ${name},\n\nYour OTP to reset your password is: ${otp}. This code is valid for 10 minutes.\n\nThank you,\nCodeArena Team`;
